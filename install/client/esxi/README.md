...
- [Official Documentation](https://networkupstools.org/downlohtml)
- [Official Documentation](https://github.com/networkupstools/nut/wiki/NUT-and-VMware-(ESXi))
- [Download Link: Pre-compiled VIB](https://rene.margar.fr/downloads/NutClient-ESXi500-1.4.0.tar.gz)
- [Download Link: 2.8.2-2.6.2-offline_bunlde.zip](https://github.com/rgc2000/NutClient-ESXi/releases/download/2.6.2/NutClient-ESXi-2.8.2-2.6.2-offline_bundle.zip)
- [Source Code](https://github.com/rgc2000/NutClient-ESXi)
...
- Connect via ssh to the host and type the following command
    ...
    # retrieve software acceptance level
    esxcli software acceptance get

    # change acceptance level to community
...
- Or use esxcli software vib remove -n upsmon
    ...
    software vib remove -n upsmon

    # change acceptance level back
